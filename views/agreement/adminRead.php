            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="addModalBody">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-xl-8 col-12">
                            <input type="text" class="form-control" id="e_formalId" name="e_formalId" value="" placeholder="กรุณากรอกเบอร์โทร" disabled>
                        </div>
                    </div>
                    <div class="row mb-4">
                        <div class="col-xl-3 col-12 text-right">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-xl-8 col-12">
                            <input type="text" class="form-control" id="e_username" name="e_username" value="" placeholder="กรุณากรอกusername" disabled>
                        </div>
                    </div>
                    <div class="row mb-4">
                        <div class="col-xl-3 col-12 text-right">
                        ...
                        <div class="col-xl-8 col-12">
                            <input type="text" class="form-control" id="e_password" name="e_password" value="" placeholder="กรุณากรอกpassword" disabled>
                        </div>
                    </div>
                    <div class="modal-footer">
